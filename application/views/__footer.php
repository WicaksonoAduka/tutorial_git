    <footer id="footer" class="footer-wrapper application no-print">
        <div class="container">
            <div class="row">
                <div class="col-md-6 footer-kompas-desc">
                    <img src="http://apps.kmn.kompas.com/static/kompas-intranet/latest/img/logo_kompas_white.svg" class="footer-logo">
                    <p>Harian Kompas adalah surat kabar Indonesia yang berkantor pusat di Jakarta. Kompas diterbitkan oleh PT Kompas Media Nusantara yang merupakan bagian dari kelompok usaha Kompas Gramedia (KG), yang didirikan oleh PK. Ojong (almarhum) dan Jakob Oetama sejak 28 Juni 1965.</p>
                    <p>Mengusung semboyan "Amanat Hati Nurani Rakyat", Kompas dikenal sebagai sumber informasi tepercaya, akurat, dan mendalam.</p>
                </div> <!--- col-md-6 --->
                <div class="col-md-4 floating">
                    <p class="blue-title">Kantor Redaksi</p>
                    <ul class="iconized">
                        <li class="list-address">
                            Gedung Kompas Gramedia<br>Jalan Palmerah Selatan 26-28<br>Jakarta 10270 Indonesia
                        </li>
                        <li class="list-phone">021 - 534 7710/20/30, 530 2200</li>
                    </ul>
                    <p class="blue-title">Kantor Iklan</p>
                    <ul class="iconized">
                        <li class="list-address">
                            <p>Gedung Iklan Kompas<br>Jalan Palmerah Selatan 15<br>Jakarta 10270 Indonesia</p>
                        </li>
                        <li class="list-phone">021 - 5367 9909, 5367 9599</li>
                        <li class="list-email">kompas@kompas.com</li>
                    </ul>
                </div> <!--- col-md-4 --->
                <div class="col-md-2">
                    <p class="blue-title">Tentang</p>
                    <ul class="iconized">
                        <li><a href="http://korporasi.kompas.id/profil/" target="_blank" title="Profil Perusahaan">Profil Perusahaan</a></li>
                        <li><a href="http://korporasi.kompas.id/sejarah/" target="_blank" title="Sejarah">Sejarah</a></li>
                    </ul>
                    <p class="blue-title">Produk</p>
                    <ul class="iconized">
                        <li><a href="http://epaper.kompas.id" target="_blank" title="ePaper">ePaper</a></li>
                        <li><a href="https://kompas.id" target="_blank" title="Kompas.Id">Kompas.Id</a></li>
                        <li><a href="http://www.kompasdata.id" target="_blank" title="Kompas Data">Kompas Data</a></li>
                        <li><a href="http://karier.kompas.id" target="_blank" title="Kompas Karier">Kompas Karier</a></li>
                    </ul>
                    <p class="blue-title">Iklan</p>
                    <ul class="iconized">
                        <li><a href="http://klasika.kompas.com/" target="_blank" title="Pasang Iklan Klasika">Klasika</a></li>
                        <li><a href="https://korporasi.kompas.id/tarif-iklan-2017/" target="_blank">Tarif</a></li>
                        <li><a href="https://adv.kompas.id/" title="Info Klasika">Advertorial</a></li>
                    </ul>
                </div> <!--- col-md-2 --->
            </div> <!--- row --->
        </div> <!--- container --->
    ...
    <div class="container no-print">
        <div class="row">
            <div class="col-md-6 footer-copyright">
                <p>© 2017-2018 - Kompas Media Nusantara, PT. All rights reserved.</p>
            </div>
            <div class="col-md-6 footer-copyright">
